...
const MyWorks = () => {
  return (
    <section id="works" className="w-full h-full bg-black text-white py-28">
      <h1 className="text-3xl uppercase tracking-[10px] text-center font-semibold">
        My Featured Works
      </h1>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-2 h-[1000px] md:h-[500px] mt-16 px-6">
        <div className="w-full h-full relative overflow-hidden group">
          <Image
            ...
            alt="ecommerce"
          />
          <div className="absolute w-full h-[500px] left-0 top-0">
